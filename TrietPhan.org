...
To use the customizations here yourself, /you must change the name of
 ...
 is 'TrietPhan', so this file is named =TrietPhan.org=, and when Emacs
 starts up with the starter kit it creates the file =TrietPhan.el=.
 
You will also need to change the values for the location of bibtex
 databases, pandoc and orgmode-mobile specified below, and some other
 settings. *Search for 'TrietPhan' in this file* to find the paths that
...
*** One space after period and global line numbers
...
#+begin_src emacs-lisp    
    ...
    '("/Users/TrietPhan/Library/texmf/bibtex/bib"))

    ;; Default bibliography
    (setq reftex-default-bibliography
    '("/Users/TrietPhan/Documents/bibs/socbib.bib"))
#+end_src
